...
from SolvingSat.solving_sat_env_v12 import SolvingSatEnv_v12
...
agent.model.save('SolvingSatEnv_v12_n_epi_' + str(n_episodes) + '_n_iter_' + str(max_iteration_ep) + '.h5')
