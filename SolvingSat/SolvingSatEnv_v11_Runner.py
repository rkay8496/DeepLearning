...
from SolvingSat.solving_sat_env_v11 import SolvingSatEnv_v11
...
class DQNAgent:
    def __init__(self, state_size, action_size):
        ...
        self.model = Sequential([
            Dense(units=state_size, input_dim=1, activation='relu'),
...
agent.model.save('SolvingSatEnv_v11_n_epi_' + str(n_episodes) + '_n_iter_' + str(max_iteration_ep) + '.h5')
