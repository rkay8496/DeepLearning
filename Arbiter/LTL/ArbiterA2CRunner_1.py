...
from Arbiter.LTL.ArbiterA2CEnv_1 import ActorCritic
import json
import os
...
agentoo7.actor.model.save(current_path + '/ArbiterA2C_1_LTL.h5')
model = tf.keras.models.load_model(current_path + '/ArbiterA2C_1_LTL.h5')
...
plt.grid(True)
plt.savefig(current_path + '/ArbiterA2C_1_LTL_avg_reward.png')
plt.show()
