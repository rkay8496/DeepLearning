...
from Arbiter.LTL.ArbiterA2CEnv_2 import ActorCritic
import json
...
agentoo7.actor.model.save('./ArbiterA2C_2.h5')
model = tf.keras.models.load_model('ArbiterA2C_2.h5')
...
plt.grid(True)
plt.savefig('./ArbiterA2C_2_avg_reward.png')
plt.show()
...
plt.grid(True)
plt.savefig('./ArbiterA2C_2_avg_trace_length.png')
plt.show()
