...
from PlatformScreenDoor.MTL.PSDA2CEnv_2 import ActorCritic
import json
...
f = open('PSDA2C_2_MTL_traces.json', 'w')
...
agentoo7.actor.model.save('./PSDA2C_2_MTL.h5')
model = tf.keras.models.load_model('PSDA2C_2_MTL.h5')
...
plt.grid(True)
plt.savefig('./PSDA2C_2_MTL_avg_reward.png')
plt.show()
