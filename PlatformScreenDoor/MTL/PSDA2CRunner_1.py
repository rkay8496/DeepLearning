...
from PlatformScreenDoor.MTL.PSDA2CEnv_1 import ActorCritic
import json
...
agentoo7.actor.model.save('./PSDA2C_1_MTL.h5')
model = tf.keras.models.load_model('PSDA2C_1_MTL.h5')
...
plt.grid(True)
plt.savefig('./PSDA2C_1_MTL_avg_reward.png')
plt.show()
