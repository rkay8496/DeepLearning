...
from PlatformScreenDoor.LTL.PSDA2CEnv_1 import ActorCritic
import json
...
f = open('PSDA2C_1_LTL_traces.json', 'w')
...
agentoo7.actor.model.save('./PSDA2C_1_LTL.h5')
model = tf.keras.models.load_model('PSDA2C_1_LTL.h5')
...
plt.grid(True)
plt.savefig('./LunarLanderA2C_learn_avg_reward_01.png')
plt.show()
