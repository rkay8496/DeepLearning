...
from Waldo.LTL.WaldoA2CEnv_2 import ActorCritic
import json
...
f = open('WaldoA2C_2_LTL_traces.json', 'w')
tf.random.set_seed(125984)
agentoo7 = agent()
steps = 1000
ep_reward = []
total_avgr = []
...
agentoo7.actor.model.save('./WaldoA2C_2_LTL.h5')
model = tf.keras.models.load_model('WaldoA2C_2_LTL.h5')
...
plt.grid(True)
plt.savefig('./WaldoA2C_2_LTL_avg_reward.png')
plt.show()
