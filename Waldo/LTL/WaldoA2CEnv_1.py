...
class ActorCritic(gym.Env):
    ...
    def take_env(self):
        def compute_observation():
            ...
            self.traces['waldo'].append((len(self.traces['waldo']), True if obs == 1 else False))
            ...
            if safety_eval and liveness_eval:
                ...
                self.traces['waldo'].pop(len(self.traces['waldo']) - 1)
                return False
