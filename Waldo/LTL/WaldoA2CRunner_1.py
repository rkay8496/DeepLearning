...
from Waldo.LTL.WaldoA2CEnv_1 import ActorCritic
import json
...
f = open('WaldoA2C_1_LTL_traces.json', 'w')
...
agentoo7.actor.model.save('./WaldoA2C_1_LTL.h5')
model = tf.keras.models.load_model('WaldoA2C_1_LTL.h5')
...
plt.grid(True)
plt.savefig('./WaldoA2C_1_LTL_avg_reward.png')
plt.show()
